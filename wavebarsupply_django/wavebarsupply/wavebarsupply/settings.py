"""
Django settings for wavebarsupply project.
...
SECRET_KEY = os.environ.get(
    'DJANGO_SECRET_KEY',
    'django-insecure-9tsik*km51#!=-9ylqp(#)=uj%s_*f-kk1)eg9z3wfa8&7s&&z')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

#ALLOWED_HOSTS = ['PavlosPapachrys.pythonanywhere.com']
...
ROOT_URLCONF = 'wavebarsupply.urls'
...
WSGI_APPLICATION = 'wavebarsupply.wsgi.application'
